    ...
    var drawChart = function (contents, types) {
        ...
        for(let j = 0; j < contents.length; j++) {
            ...
            if (types[j] == 0) {
                ...
                noTableAndChartDraw(content, idx);
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if(chartData != null){
                ...
                $("tbody tr:odd td").css("background-color", chartData.table.bocolor+'!important');
                $("tbody tr:even td").css("background-color", chartData.table.becolor+'!important');
            }
